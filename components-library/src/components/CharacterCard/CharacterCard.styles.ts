...
export const favoriteIconContainerSx: SxProps<Theme> = {
  position: "absolute",
  top: "8px",
  left: "8px",
  zIndex: 1,
...
export const characterNameSx: SxProps<Theme> = {
  lineHeight: 1.2,
...
export const speciesContainerSx: SxProps<Theme> = {
  flex: 1,
  marginTop: "-8px",
...
export const speciesTextSx: SxProps<Theme> = {
...
// Bottom section
// ---------------------------
export const bottomSectionSx: SxProps<Theme> = {
  display: "grid",
...
export const bottomItemSx: SxProps<Theme> = {
  display: "flex",
  flexDirection: "column",
  gap: "4px",
};
